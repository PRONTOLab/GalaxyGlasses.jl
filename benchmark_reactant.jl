...
function run_benchmark(;
    ...
    noise = BayesMM.make_simulation_noise(n_gal)

    println("Benchmarking Julia and Reactant for $n_gal rows...")
    benchmark = BayesMM.benchmark_forward_model(
        inputs,
    ...
    report = BayesMM.format_benchmark_report(
        dataset,
        n_gal,
        benchmark.timings,
    ...
    row = BayesMM.benchmark_result_row(
        dataset,
        n_gal,
        benchmark.timings,
        benchmark.correctness;
